...
function TotalVolatility(graphData, Q1, Q2) {
  ...
  var width = $("#TotalVolatility").width();
  var height = $("#TotalVolatility").height();
...
function CompaniesImpacted(graphData, Q1, Q2) {
  ...
  var height = $("#CompaniesImpacted").height();
...
function AverageVolatility(graphData, Q1, Q2) {
  ...
  var height = $("#AverageVolatility").height();
...
function BigGraph(graphData, Q1, Q2) {
  ...
  var width = $("#BigGraph").width();
  var height = $("#BigGraph").height();
